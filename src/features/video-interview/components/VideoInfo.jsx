...
const VideoInfo = ({ phase, totalDuration, onRetake }) => {
  const isRecording = phase === "recording";
  const canRetake = phase === "review";
      ...
      <div className="flex flex-col gap-4 md:hidden">
        <div className="flex items-center justify-between">
          <div
            ...
            } flex items-center gap-2 rounded-full border border-black bg-[#A30000CC] px-3 py-2`}
          >
        ...
        <div className="flex justify-center">
          <RecordingTimer phase={phase} totalDuration={totalDuration} />
        </div>
      ...
      <div className="hidden items-center md:flex">
        <div className="flex flex-1 justify-center">
          <div
            className={`${
              isRecording ? "visible" : "invisible"
            } flex items-center gap-2 rounded-full border border-black bg-[#A30000CC] px-4 py-2`}
          >
            <div className="relative">
              <Circle size={10} className="fill-white text-white" />
